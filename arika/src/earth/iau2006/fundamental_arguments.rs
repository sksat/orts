...
//! arika follows the exact values so that the ERFA-generated fixture in
//! `arika/tests/fixtures/iau2006_erfa_reference.json` agrees bit-level.
...
mod tests {
    ...
    // pinned by the integration test at `arika/tests/iau2006_vs_erfa.rs`,
