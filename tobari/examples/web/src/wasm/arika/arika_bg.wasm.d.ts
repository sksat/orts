...
export const body_orientation: (a: number, b: number, c: number, d: number) => [number, number];
export const body_quat_to_rsw: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number) => [number, number];
