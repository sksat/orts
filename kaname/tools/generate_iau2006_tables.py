...
Rust module at `kaname/src/earth/iau2006/tables_gen.rs` containing:
...
Luzum eds., IERS Conventions 2010). kaname's LICENSE remains MIT; the
...
// arrays for consumption by `kaname::earth::iau2006`. See the top-level
// kaname DESIGN.md section on the IAU 2006 CIO chain.
