...
//! 詳細は [`kaname/DESIGN.md`](../../DESIGN.md) の「時刻系と座標系・測地系の定義
//! レベルの結合」を参照。
//!
//! # Scale-specific API
//!
...
/// kaname redesign. Callers requiring bit-accurate pre-1972 ephemerides
...
/// A time scale marker.
///
/// Sealed: 新しい scale は kaname 内でのみ追加できる。
...
///
/// Note: the current kaname source value `1.002_737_811_911_354_6` differs
