/**
 * The axis triad's colours, letters and label placement.
 *
 * Pure: these numbers are shared by the meshes that draw the axes, the sprites
 * that name them, and the camera fit that has to keep both on screen.
 */

/** In the order `AxesHelper` draws them, which the triad keeps. */
