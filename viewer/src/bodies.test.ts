 ...
 *
 * Reference quaternions are generated by arika's Rust IAU rotation model
 * (arika/src/rotation.rs `generate_fixture_quaternions` test). This ensures
...
describe("Moon texture orientation pipeline", () => {
   ...
   * arika's Rust implementation. These serve as the ground truth.
   */
  const FIXTURES = [
    {
      body: "moon",
  ...
  /** Build Three.js quaternion from arika fixture [w, x, y, z] */
  ...
  it("full pipeline: Moon texture center faces Earth at Apollo 11 epoch", () => {
    ...
    // Moon position at Apollo 11 end (from arika moon_position_eci)
  ...
  it("full pipeline: Moon texture center faces Earth at Apollo 11 start", () => {
    ...
    // Moon position at Apollo 11 start (from arika moon_position_eci)
