...
- Propagation frames: `SimpleEci` (ERA-only Earth rotation) and `Gcrs` (IAU 2006/2000A CIO chain with observed IERS EOP, `orts run --sat altitude=400 --frame gcrs --eop auto`, or `frame = "gcrs"` in a config)
